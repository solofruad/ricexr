...
/// copiar la textura a Materials/&lt;Enfermedad&gt;/ con el mismo nombre y anadir la linea
/// "PrefabN|{hoja}|{hoja}.ext" al mapeo. Si el prefab no existe se crea copiando la plantilla.
/// </summary>
public static class RiceXRMigration
{
    private const string RynchoFbxPath = "Assets/Hojas/Assets/Mesh/ryncho_v2.fbx";
    private const string RynchoOldFbxPath = "Assets/Hojas/Assets/Mesh/ryncho2.fbx";
    private const string RynchoMatDir = "Assets/Hojas/Assets/Materials/Rynchosporium";
    private const string RynchoPrefabDir = "Assets/Hojas/Prefabs/Leaves/Rynchosporium/Nuevos";

    private const string PyriFbxPath = "Assets/Hojas/Assets/Mesh/pyri_v2.fbx";
    private const string PyriOldFbxPath = "Assets/Hojas/Assets/Mesh/pyri.fbx";
    private const string PyriMatDir = "Assets/Hojas/Assets/Materials/Pyricularia";
    private const string PyriPrefabDir = "Assets/Hojas/Prefabs/Leaves/Pyricularia/Nuevos";

    private const string NoisePath = "Assets/Hojas/Shaders/Textures/noise.png";
    ...
    {
        RunMigration("Ryncho", RynchoFbxPath, RynchoOldFbxPath, RynchoMatDir, RynchoPrefabDir, RynchoMapping, "Ryncho1");
    }

    [MenuItem("Tools/RiceXR/Migrar Hojas Pyri v2")]
    public static void MigratePyri()
    {
        RunMigration("Pyri", PyriFbxPath, PyriOldFbxPath, PyriMatDir, PyriPrefabDir, PyriMapping, "Pyricularia1");
    }

    private static void RunMigration(
        string tag, string fbxPath, string oldFbxPath, string matDir,
