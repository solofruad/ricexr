public static class GameNarrationLineIds
{
    ...
    public const string ProgressRemain10 = "PROGRESS_REMAIN_10";
    public const string ProgressRemain9 = "PROGRESS_REMAIN_9";
    public const string ProgressRemain8 = "PROGRESS_REMAIN_8";
    public const string ProgressRemain7 = "PROGRESS_REMAIN_7";
    public const string ProgressRemain6 = "PROGRESS_REMAIN_6";
    public const string ProgressRemain5 = "PROGRESS_REMAIN_5";
    public const string ProgressRemain4 = "PROGRESS_REMAIN_4";
